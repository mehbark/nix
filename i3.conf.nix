...
#both
bindsym $mod+b exec --no-startup-id ~/.screenlayout/affiancati.sh
#my
bindsym $mod+m exec --no-startup-id ~/.screenlayout/only_laptop.sh
#only ext
bindsym $mod+n exec --no-startup-id ~/.screenlayout/only_external.sh
...
exec --no-startup-id xinput set-prop 9 280 1
exec --no-startup-id /usr/lib/polkit-gnome/polkit-gnome-authentication-agent-1 & eval $(gnome-keyring-daemon -s --components=pkcs11,secrets,ssh,gpg) &

bindsym --release $mod+p exec  maim -s --format=png /dev/stdout | xclip -selection clipboard -t image/png -i
bindsym $mod+c exec --no-startup-id chromium
exec --no-startup-id feh --bg-scale /home/nicomazz/Pictures/giau_pass_italy_alps_118374_1920x1080.jpg
